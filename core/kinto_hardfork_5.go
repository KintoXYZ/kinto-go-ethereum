...
var (
	dinaryEOAsA = []common.Address{
		common.HexToAddress("0x8D69Ec4029c7d634a06FaB50da4b538499FC8598"),
		common.HexToAddress("0x874c1606c678cdA1d0f054f5123567198B13fedF"),
	...
	dinaryContractsA = []common.Address{
	...
	dinaryEOAsB = []common.Address{
		common.HexToAddress("0x2bF22fD411C71b698bF6e0e937b1B948339Ec369"),
		common.HexToAddress("0x0556Fe4ddffE2798BA34E1A92306B12cBC6c94fC"),
	...
	dinaryContractsB = []common.Address{
...
func enforceHardForkFiveRules(msg *Message) error {
	...
	if (containsAddress(dinaryEOAsA, origin) && containsAddress(dinaryContractsA, *destination)) ||
		(containsAddress(dinaryEOAsB, origin) && containsAddress(dinaryContractsB, *destination)) {
